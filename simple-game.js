...
var simpleLevelPlan = [[ // initial input for Level
  ...
  "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx| x    x          ",
  "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx       x          ",
  "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx       x          ",
...
Level.prototype.playerTouched = function(type, actor) {
  if (type == "lava" && this.status == null) {
    ...
    if (!this.actors.some(function(actor) {
      ...
      this.status = "won";
      window.location.href = "mailto:evankhaledhosni@gmail.com?Subject=You\'re hired!";
